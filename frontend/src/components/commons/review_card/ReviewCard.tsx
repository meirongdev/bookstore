    ...
    return (
        ...
        <div className="flex flex-col gap-5 p-5 rounded-lg shadow-custom-3">
            ...
            <div className="flex max-md:flex-col justify-between md:items-center">
                ...
                <div className="flex gap-4 items-center text-lg">
                    ...
                    <div className="flex gap-3 max-lg:flex-col max-lg:gap-0">
                        ...
                        <p className="font-bold">{review.userFirstName}</p>

                        <p className="font-light">{review.userEmail}</p>
            ...
            <div className="text-lg">
                ...
                {review.reviewDescription ? `"${review.reviewDescription}"` : <p className=" opacity-70">This user did not leave a comment</p>}
