...
export const DiscussionsPage = () => {
    ...
    const tabs = [
        { id: 'new' as TabType, label: 'New Discussion', icon: '✍️' },
        { id: 'all' as TabType, label: 'All Discussions', icon: '💬' }
    ];
            ...
            <div className="container-centered px-5">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        {activeTab === 'new' && <NewDiscussionTab />}
                        {activeTab === 'all' && <AllDiscussionsTab setActiveTab={setActiveTab} />}
                    </div>
