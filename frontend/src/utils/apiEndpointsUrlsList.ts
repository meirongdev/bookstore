...
// ------------------------------------------------------------------------------------------------------------
const base_url =  `${globalThis.location.origin}${import.meta.env.VITE_BACKEND_BASE_URL}`;
...
const book_loan_controller_entry      = `${base_url}${import.meta.env.VITE_BOOK_LOAN_CONTROLLER_URL_PART}`;
...
const upload_controller_entry       = `${base_url}${import.meta.env.VITE_UPLOAD_CONTROLLER_URL_PART}`;
...
// ------------------------------------------------------------------------------------------------------------
const create_payment_intent_endpoint = "/create-payment-intent";
const confirm_payment_endpoint       = "/confirm";
const get_user_payments_endpoint     = "/user";
const get_pending_amount_endpoint    = "/user/pending-amount";
...
export const book_loan_controller_endpoints = {

    find_all_book_loans: { method: "GET", url: new URL(`${book_loan_controller_entry}${secure_url_part}`) }
...
export const payment_controller_endpoints = {
    ...
    confirm_payment:       { method: "POST", url: new URL(`${payment_controller_entry}${secure_url_part}${confirm_payment_endpoint}`) },
    get_user_payments:     { method: "GET",  url: new URL(`${payment_controller_entry}${secure_url_part}${get_user_payments_endpoint}`) },
    get_pending_amount:    { method: "GET",  url: new URL(`${payment_controller_entry}${secure_url_part}${get_pending_amount_endpoint}`) }
...
export const upload_controller_endpoints = {
    upload_image: { method: "POST", url: new URL(`${upload_controller_entry}${secure_url_part}`) }
};
