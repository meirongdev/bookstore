package dev.meirong.showcase.bookstore.openapi;
...
@OpenAPIDefinition(
        info = @Info(
                contact = @Contact(name = "Meirong", email = "meirongdev@gmail.com", url = "https://github.com/meirongdev"),
                description = "OpenAPI documentation for Book Store Project backend application.",
                title = "OpenAPI specification - Meirong",
                version = "1.0",
